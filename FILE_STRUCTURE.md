...
### Database
```
📄 siletube.db                    # SQLite database
📄 siletube.db-shm                # Shared memory file
📄 siletube.db-wal                # Write-ahead log
```
...
2. Delete `siletube.db` to recreate

---

**SileTube** - Clean, organized, and ready to scale! 📂
