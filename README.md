...
![SileTube](https://img.shields.io/badge/SileTube-Modern%20Video%20Platform-3EA6FF?style=for-the-badge)
...
├── siletube.db             # SQLite database (auto-created)
└── package.json
```
...
- Delete `siletube.db` and restart
...
**SileTube** - Your videos, your vibe! 🎵
