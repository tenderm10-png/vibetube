...
SileTube is a **fully functional YouTube clone** with:
...
- Database file is `siletube.db` in root
...
SileTube is ready to use. Start the server and build something amazing!
